...
<div>
    ...
    <div class="">
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-slate-900 bg-slate-50 focus:ring-blue-500 dark:bg-slate-700 dark:placeholder-slate-400 dark:text-white dark:focus:ring-blue-500" placeholder="Search Reparations..." required />
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mb-5">
                                ...
                                <select id="status" name="status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                    ...
                                    <option value="In_Progress" id="in_progress">In Progress</option>
