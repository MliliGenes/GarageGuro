...
<div>
    <form class="" action="{{route("dashboard.mechanics.search")}}">
        ...
        <div class="relative">
            ...
            <input type="search" name="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900  bg-gray-50 focus:ring-blue-500 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 " placeholder="Search Clients..." required />
