...
<div>
    <div>
        ...
        <div class="relative">
            ...
            <button type="submit" class="h-full w-32 text-white absolute bottom-0 right-0 bg-blue-700 hover:bg-blue-800  font-medium  text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 ">Search</button>
        </div>
    </div>
