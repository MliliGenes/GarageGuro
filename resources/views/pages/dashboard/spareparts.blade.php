...
<div>
    <div class="">
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-slate-900 bg-slate-50 focus:ring-blue-500 dark:bg-slate-700 dark:placeholder-slate-400 dark:text-white dark:focus:ring-blue-500" placeholder="Search Spare Parts..." required />
