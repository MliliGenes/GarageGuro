...
<div class="px-20 py-4 w-full">
    <div class="mb-8">
        <h2 class="text-4xl text-slate-800 mb-2">Reset Password</h2>
        <p class="text-slate-500 text-md">Enter your new password below.</p>
    </div>
    <form action="{{ route('reset.password.post') }}" method="post" class="flex flex-col gap-2">
        ...
        <div class="flex flex-col gap-2">
            <label for="email_address" class="text-slate-500 block text-sm pl-2">E-Mail Address</label>
        ...
        <div class="flex flex-col gap-2">
            <label for="password_confirmation" class="text-slate-500 block text-sm pl-2">Confirm Password</label>
