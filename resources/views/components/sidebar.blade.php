...
<aside class="min-w-80 bg-slate-700  py-2 px-3 divide-y divide-slate-500  overflow-y-auto">
    ...
    <ul class="flex flex-col gap-2 py-3 px-3">
        ...
        <li class="text-slate-200   text-lg "><a href="#" class="shadow-md py-1 px-3 bg-slate-500 rounded flex gap-3 items-center"><i class="fa-solid fa-people-group text-slate-800 min-w-5"></i> Mechanicians List</a></li>
        <li class="text-slate-200   text-lg "><a href="#" class="shadow-md py-1 px-3 bg-slate-500 rounded flex gap-3 items-center"><i class="fa-solid fa-person-circle-plus text-slate-800 min-w-5"></i> Add Mechanician</a></li>
        <li class="text-slate-200   text-lg "><a href="#" class="shadow-md py-1 px-3 bg-slate-500 rounded flex gap-3 items-center"><i class="fa-solid fa-file-arrow-up text-slate-800 min-w-5"></i> Import Mechanicians</a></li>
        <li class="text-slate-200   text-lg "><a href="#" class="shadow-md py-1 px-3 bg-slate-500 rounded flex gap-3 items-center"><i class="fa-solid fa-file-arrow-down text-slate-800 min-w-5"></i> Export Mechanicians</a></li>
    </ul>
